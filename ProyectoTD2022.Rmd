...
ggplot(data.frame(r1,r2), aes(x=r1, y=r2)) +geom_point() +geom_hline(yintercept=0, color = "green") +geom_vline(xintercept=0, color = "red") 
```
...
p2
```
Como los valores son proximos a uno, **`r p2`**,podemos decir que el grado de relacion lineal entre ellos es alto.
...
p4
```
Como los valores no son tan cercanos a uno,**`r p4`**,podemos decir que el grado de relacion lineal entre ellos es mas bajo que el de las dos primeras variables.
